...
export default function Navbar() {
  ...
  // Portal needs the client to be mounted before document.body exists
    ...
    <>
      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8 md:py-5">
          ...
          {/* CTA + hamburger — 把 AI Finder 做成高亮玻璃按钮，突出核心功能 */}
      ...
      {/* ============ Mobile drawer (ported to body to escape header's stacking context) ============ */}
      {mounted &&
        createPortal(
          <div
            className={`md:hidden ${
            ...
            >
              ...
              <div className="mt-auto">
                ...
                <p className="text-center text-xs leading-relaxed text-ink/50">
                  GiftHive · Pick the right gift, skip the guessing.
                  <br />
                  This site uses affiliate links — see the footer.
                </p>
              </div>
            </div>
          </div>,
